    ...
    return(
        <section className="w-full relative text-neutral-50 py-20 md:py-25 lg:py-30">
            <div className="flex flex-col items-center gap-10 p-5">
                <h3 className="text-xl md:text-2xl flex gap-2 items-center">
                ...
                <NavLink
                    to="/collection"
                    className="relative flex items-center justify-end gap-1.5 bg-lime-300 text-neutral-950 rounded-full px-5 h-12 cursor-pointer group"
                >
