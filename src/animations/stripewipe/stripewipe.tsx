...
export default function StripeWipe(){
    ...
    const text = "Doloremque expedita neque iste consequuntur nemo nihil maxime autem rerum totam suscipit."
        ...
        <section className="h-[500dvh] relative" ref={sectionRef}>
            <div className="sticky top-0 w-full h-dvh flex flex-col items-center justify-center">
                <div className="w-full h-full absolute top-0 left-0">
                    {stripeHeights.map((height, index) => (
                        <div key={index} style={{ height: `${height}dvh`, overflow: "hidden" }}>
                            <div
                                style={{ background: "#aab2ff", height: `${height}dvh`, width: '100%' }}
                                className="stripe"            
                            >
                ...
                <div className="flex flex-col gap-4 items-center" ref={containerRef}>
                    <p className="flex gap-x-3 lg:text-7xl font-medium max-w-225 flex-wrap relative text-neutral-950 justify-center">
