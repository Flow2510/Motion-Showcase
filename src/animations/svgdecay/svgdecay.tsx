...
export default function SvgDecay() {
    ...
    const left = useTransform(scrollYProgress, [0, 0.33], ["-100%", "0%"])
    const right = useTransform(scrollYProgress, [0, 0.33], ["100%", "0%"])
    const down = useTransform(scrollYProgress, [0.33, 0.66], ["0%", "100%"])
    const up = useTransform(scrollYProgress, [0.33, 0.66], ["0%", "-100%"])
    const scale = useTransform(scrollYProgress, [0.66, 1], [1, 0.25])
